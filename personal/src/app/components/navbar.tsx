...
const Navbar: React.FC = ({textColor}) => {
  ...
  return (
    <>
    <nav className={`flex flex-row gap-5 items-center py-10 justify-between font-medium text-xl font-generalSans ${textColor}`}>
    ...
    <h1 className=''>Gede Astu</h1></div>
    <div className='flex flex-row gap-5 items-center'>
    {dataNavLink.map((data)=>(
    <Link key={data.id} href={data.hrefLink} className=''>
        {data.nameLink}
    </Link>
    ))}
